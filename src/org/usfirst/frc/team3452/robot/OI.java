...
public class OI {
	...
	public static void init() {
		 ...
		 * 
		 * // OP JOY opJoyLB.whileHeld(new ElevatorManual(opJoy));
		 * opJoyRB.whileHeld(new Climb(.7));
		 * 
		 * opJoyBack.whileHeld(new IntakeSpin(.35, true));
		 * opJoyStart.whileHeld(new IntakeSpin(.35, false));
		 * 
		 * opJoyX.whileHeld(new IntakeControl(-.75, 0.01)); opJoyB.whileHeld(new
		 * IntakeControl(.75, 0.01)); opJoyY.whileHeld(new IntakeControl(.3,
		 * 0.01)); opJoyA.whenPressed(new ElevatorPosition(3));
		 * 
